...
c:\gameboy-dev\gbdk\bin\lcc -Wa-l -Wl-m -Wl-j -c -o build\game-state-password.o game-state-password.c
c:\gameboy-dev\gbdk\bin\lcc -Wa-l -Wl-m -Wl-j -c -o build\game-state-chapter-intro.o game-state-chapter-intro.c
c:\gameboy-dev\gbdk\bin\lcc -Wa-l -Wl-m -Wl-j -c -o build\game-state-game.o game-state-game.c
c:\gameboy-dev\gbdk\bin\lcc -Wa-l -Wl-m -Wl-j -c -o build\game-state-pause.o game-state-pause.c
...
c:\gameboy-dev\gbdk\bin\lcc -Wa-l -Wl-m -Wl-j -o build\_gridwalker.gb^
  ...
  build\game-state-password.o^
  build\game-state-chapter-intro.o^
  build\game-state-game.o^
  build\game-state-pause.o^
  build\game-state-credits.o^
  build\main.o